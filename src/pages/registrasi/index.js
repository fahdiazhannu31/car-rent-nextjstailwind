    ...
    return (
        <section className="flex items-center justify-center min-h-screen">
            ...
            <form className="space-y-4 md:space-y-6" action="#">
                  ...
                  <div>
                      <label for="confirm-password" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Konfirmasi password</label>
                  ...
                  <div className="flex items-start">
                      ...
                      <div className="ml-3 text-sm">
                        <label for="terms" className="font-light text-gray-500 dark:text-gray-300">Saya terima dan mengerti<a className="font-medium text-blue-600 hover:underline dark:text-blue-500" href="#">Syarat dan Ketentuan</a></label>
                      </div>
                  </div>
                  ...
                  <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                      Sudah punya akun? <a href="login/" className="font-medium text-blue-600 hover:underline dark:text-blue-500">Masuk di sini</a>
                  </p>
              </form>
            </div>
        </section>
