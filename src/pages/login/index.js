export default function login() {
    return (
        <section className="flex items-center justify-center min-h-screen">
            <img src="images/login.png" className="w-1/2 h-auto mr-4" alt="Fortuner" />
            <div className="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                <form className="space-y-6" action="#">
                    ...
                    <div className="flex items-start">
                        ...
                        <a href="#" className="ml-auto text-sm text-blue-700 hover:underline dark:text-blue-500">Lupa Password?</a>
                    </div>
                    ...
                    <div className="text-sm font-medium text-gray-500 dark:text-gray-300">
                        Belum punya akun? <a href="registrasi/" className="text-blue-700 hover:underline dark:text-blue-500">Buat akun</a>
                    </div>
                </form>
            </div>
        </section>
